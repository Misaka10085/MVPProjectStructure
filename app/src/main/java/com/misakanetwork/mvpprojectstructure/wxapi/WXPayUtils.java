...
public class WXPayUtils {
    ...
    public void toWXPayNotSign(Context context) {
        ...
        if (!iwxapi.isWXAppInstalled()) {
            Toast.makeText(context, "您尚未安装微信客户端", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        Runnable payRunnable = new Runnable() {  //这里注意要放在子线程
            ...
            public void run() {
                ...
                if (builder.getPrepayId() != null) request.prepayId = builder.getPrepayId();
...
//                request.timeStamp = String.valueOf(genTimeStamp());
                ...
                if (request.partnerId != null) signParams.put("partnerid", request.partnerId);
