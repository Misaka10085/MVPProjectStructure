 ...
 * class name：CashierInputFilterIn2
 * desc：EditText保留小数点后2位的金额输入控制Filter，配合MoneyWatcher使用
 */
public class CashierInputFilterIn2 implements InputFilter {
    Pattern mPattern;
