package com.misakanetwork.lib_common.utils.agentweb;
 ...
 * on：2021/12/30
 * package：com.misakanetwork.lib_common.utils.agentweb
 * class name：VideoEnabledWebChromeClient
 * desc：agentWeb videoFullScreen fix
 * use:
 * .setWebChromeClient(new VideoEnabledWebChromeClient(backgroundLayout, videoLayout) { // backgroundLayout:agentWebView's container; videoLayout:fullScreenView
 *
 ...
 * <p>
 * onKeyDown:
 * if (mAgentWeb.handleKeyEvent(keyCode, event) && !isVideoFullscreen) {
 * return true;
 * }
...
public class VideoEnabledWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
     ...
     */
    @SuppressWarnings("unused")
    public VideoEnabledWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView, AgentWebView webView) {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
        this.loadingView = loadingView;
