package com.misakanetwork.lib_common.widget.wechatswitch.switchview;
...
import com.misakanetwork.lib_common.widget.wechatswitch.motionevent.ScGestureUtils;

/**
 * Created By：Misaka10085
 * on：2021/7/15
 * package：com.misakanetwork.lib_common.widget.wechatswitch.switchview
 * class name：WeChatSwitchBtn
 * desc：仿微信SwitchBtn/仿iOS的UiSwitch控件 switch_ball_side_status:选中状态
 * <p>
 * Paint类介绍
 * <p>
...
public class WeChatSwitchBtn extends View implements View.OnClickListener {
    ...
    private int mBgSideColor = Color.parseColor("#606366");//底板的描边颜色
    private int mOffBgColor = Color.parseColor("#F1F3F4");//关闭时底板的颜色
    private int mOpenBgColor = Color.parseColor("#FFB01A");//开启时底板的颜色
    ...
    private boolean mIsBallSide = true;//是否需要圆球描边,默认false
    ...
    private ScGestureUtils mGestureUtils;//手势工具类
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //解决软键盘弹起导致按钮关闭的问题,把参数设置放到onSizeChanged()中
...
//        drawBallStroke(canvas);
    ...
    private void toggleOn() {
        ...
        if (mOpenAnimator == null) {
            ...
            mOpenAnimator.setDuration(ANIMATION_DURATION);
    ...
    private void toggleOff() {
        ...
        if (mCloseAnimator == null) {
            ...
            mCloseAnimator.setDuration(ANIMATION_DURATION);
