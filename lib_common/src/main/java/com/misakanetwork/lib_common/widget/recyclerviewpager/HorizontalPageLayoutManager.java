 ...
 * on：2021/7/6
 * package：com.misakanetwork.lib_common.widget.recyclerviewpager
 * class name：HorizontalPageLayoutManager
 * desc：HorizontalPageLayoutManager 不支持RecyclerView上设置Padding，需要有具体的高度
 * <p>
 * RecyclerView.LayoutManager layoutManager = new HorizontalPageLayoutManager(2, 3); // 不支持RecyclerView上设置Padding
